...
const MainPage = (p) => {
  ...
  let mainTexts = [
    ...
    { text: "Bandcamp", x: 0, y: 0, sensitivities: [], hoverStartTime: 0, isHovered: false, url: "https://reptilianbusinessrecords.bandcamp.com/album/snk-operator" },
  ...
  p.preload = () => {
    ...
    shockWaveShader = p.loadShader('assets/glsl/main-v3.vert', 'assets/glsl/shock.frag');
  };
  ...
  p.setup = () => {
    ...
    // Initialize Shaderland (commented out - not available)
    ...
    mainTexts[0].y = centerY - lineSpacing * 1.5;
    mainTexts[1].x = centerX;
    mainTexts[1].y = centerY - lineSpacing * 0.5;
    mainTexts[2].x = centerX;
    mainTexts[2].y = centerY + lineSpacing * 0.5;
    mainTexts[3].x = centerX;
    mainTexts[3].y = centerY + lineSpacing * 1.5;
